...
def generate_launch_description():
    ...
    common_bt_params = {
        ...
        'recovery.require_recovery_buff_for_confirm': LaunchConfiguration('require_recovery_buff_for_confirm'),
        ...
        'tactical_state_min_hold_ms': LaunchConfiguration('tactical_state_min_hold_ms'),
        'internal_motion_min_hold_ms': LaunchConfiguration('internal_motion_min_hold_ms'),
        'posture_candidate_confirm_ms': LaunchConfiguration('posture_candidate_confirm_ms'),
        'posture_min_hold_ms': LaunchConfiguration('posture_min_hold_ms'),
        'attack_enter_confirm_ms': LaunchConfiguration('attack_enter_confirm_ms'),
        'defense_enter_confirm_ms': LaunchConfiguration('defense_enter_confirm_ms'),
        'move_enter_confirm_ms': LaunchConfiguration('move_enter_confirm_ms'),
        'nav_goal_timeout_as_temp_defense_ms': LaunchConfiguration('nav_goal_timeout_as_temp_defense_ms'),
        ...
        'spin_hysteresis_enabled': LaunchConfiguration('spin_hysteresis_enabled'),
        'spin_on_confirm_ms': LaunchConfiguration('spin_on_confirm_ms'),
        'spin_off_confirm_ms': LaunchConfiguration('spin_off_confirm_ms'),
        'spin_min_on_ms': LaunchConfiguration('spin_min_on_ms'),
        'spin_min_off_ms': LaunchConfiguration('spin_min_off_ms'),
        'spin_target_hold_ms': LaunchConfiguration('spin_target_hold_ms'),
        'spin_under_attack_hold_ms': LaunchConfiguration('spin_under_attack_hold_ms'),
        'spin_hp_drop_threshold': LaunchConfiguration('spin_hp_drop_threshold'),
        'engage_target_max_distance_m': LaunchConfiguration('engage_target_max_distance_m'),
        'fire_policy_hysteresis_enabled': LaunchConfiguration('fire_policy_hysteresis_enabled'),
        'fire_policy_on_confirm_ms': LaunchConfiguration('fire_policy_on_confirm_ms'),
        'fire_policy_off_confirm_ms': LaunchConfiguration('fire_policy_off_confirm_ms'),
        'fire_policy_min_on_ms': LaunchConfiguration('fire_policy_min_on_ms'),
        'fire_policy_min_off_ms': LaunchConfiguration('fire_policy_min_off_ms'),
        'fire_policy_target_hold_ms': LaunchConfiguration('fire_policy_target_hold_ms'),
    }
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('require_recovery_buff_for_confirm', default_value='false'),
        DeclareLaunchArgument('hp_resupply_enter_ratio', default_value='0.65'),
        DeclareLaunchArgument('hp_resupply_exit_ratio', default_value='0.98'),
        ...
        DeclareLaunchArgument('resupply_goal_timeout_ms', default_value='10000'),
        DeclareLaunchArgument('resupply_wait_recovery_timeout_ms', default_value='12000'),
        DeclareLaunchArgument('resupply_candidate_switch_cooldown_ms', default_value='1000'),
        DeclareLaunchArgument('patrol_goals', default_value='["SEARCH_AREA_B", "MID_CROSS", "SEARCH_AREA_A"]'),
        DeclareLaunchArgument('tactical_state_min_hold_ms', default_value='3000'),
        DeclareLaunchArgument('internal_motion_min_hold_ms', default_value='3000'),
        DeclareLaunchArgument('posture_candidate_confirm_ms', default_value='1000'),
        DeclareLaunchArgument('posture_min_hold_ms', default_value='5000'),
        DeclareLaunchArgument('attack_enter_confirm_ms', default_value='150'),
        DeclareLaunchArgument('defense_enter_confirm_ms', default_value='1000'),
        DeclareLaunchArgument('move_enter_confirm_ms', default_value='300'),
        DeclareLaunchArgument('nav_goal_timeout_as_temp_defense_ms', default_value='12000'),
        DeclareLaunchArgument('resupply_candidates', default_value='["SUPPLY_LEFT", "SUPPLY_RIGHT"]'),
        DeclareLaunchArgument('dead_return_home_enabled', default_value='true'),
        DeclareLaunchArgument('dead_return_goal', default_value='SUPPLY_LEFT'),
        ...
        DeclareLaunchArgument('goal_dwell_default_ms', default_value='12000'),
        DeclareLaunchArgument('goal_dwell_search_ms', default_value='12000'),
        DeclareLaunchArgument('goal_dwell_hold_ms', default_value='12000'),
        DeclareLaunchArgument('goal_dwell_resupply_ms', default_value='0'),
        DeclareLaunchArgument('goal_dwell_engage_ms', default_value='0'),
        DeclareLaunchArgument('spin_hysteresis_enabled', default_value='true'),
        DeclareLaunchArgument('spin_on_confirm_ms', default_value='0'),
        DeclareLaunchArgument('spin_off_confirm_ms', default_value='0'),
        DeclareLaunchArgument('spin_min_on_ms', default_value='0'),
        DeclareLaunchArgument('spin_min_off_ms', default_value='0'),
        DeclareLaunchArgument('spin_target_hold_ms', default_value='5000'),
        DeclareLaunchArgument('spin_under_attack_hold_ms', default_value='5000'),
        DeclareLaunchArgument('spin_hp_drop_threshold', default_value='0'),
        DeclareLaunchArgument('engage_target_max_distance_m', default_value='7.0'),
        DeclareLaunchArgument('fire_policy_hysteresis_enabled', default_value='true'),
        DeclareLaunchArgument('fire_policy_on_confirm_ms', default_value='150'),
        DeclareLaunchArgument('fire_policy_off_confirm_ms', default_value='800'),
        DeclareLaunchArgument('fire_policy_min_on_ms', default_value='1500'),
        DeclareLaunchArgument('fire_policy_min_off_ms', default_value='500'),
        DeclareLaunchArgument('fire_policy_target_hold_ms', default_value='1200'),
