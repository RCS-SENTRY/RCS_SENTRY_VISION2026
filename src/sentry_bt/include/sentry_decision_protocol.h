...
typedef enum
{
    SENTRY_TACTICAL_STATE_RETREAT = 0,
    SENTRY_TACTICAL_STATE_RESUPPLY = 1,
    SENTRY_TACTICAL_STATE_HOLD = 2,
    SENTRY_TACTICAL_STATE_ENGAGE = 3,
    SENTRY_TACTICAL_STATE_SEARCH = 4,
    SENTRY_TACTICAL_STATE_REPOSITION = 5
...
typedef enum
{
    ...
    SENTRY_RULE_ACTION_ACTIVATE_ENERGY = 4,
    SENTRY_RULE_ACTION_CLAIM_PERIODIC_AMMO = 5,
